...
const ModalBuilderConfirm: FC<IProps> = ({ open, onClose, onConfirm }) => {
  return (
    <Modal open={open} onClose={onClose}>
      <Dialog.Panel className={styles.modalLayoutBig}>
        ...
        <div className="flex flex-col items-center justify-center text-white gap-4">
          ...
          <div>This will register your wallet as a builder to the PoN Relay.</div>
...
export default ModalBuilderConfirm
